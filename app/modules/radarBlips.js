...
const drawRadarBlip = (blip, d, viewpoint) => {
    ...
    try {
        ...
        try {
            ...
            if (viewpoint.template.colorConfiguration.colors[blipColorId]?.visible== false) return
        } catch (e) {
            blipColor = "blue"
        ...
        try {
            ...
            if (viewpoint.template.sizeConfiguration.sizes[blipSizeId]?.visible== false) return
