...
const technologies = [
    ...
    { label: "Python", category: "language", image: "", homepage: "", tags: ["", ""] , offering:"oss"},
    {
        ...
        , homepage: "https://www.postgresql.org/", tags: ["open source", "rdbms", "sql", "acid"], offering:"oss", description:`PostgreSQL also known as Postgres, is a free and open-source relational database management system (RDBMS) emphasizing extensibility and SQL compliance. It was originally named POSTGRES, referring to its origins as a successor to the Ingres database developed at the University of California, Berkeley. In 1996, the project was renamed to PostgreSQL to reflect its support for SQL. After a review in 2007, the development team decided to keep the name PostgreSQL and the alias Postgres.
