...
const supportedShapes = {
    ...
    star: {},
    ring: {},
    leftArrow: {externalShape:true, symbolId:"icon-arrow-thick-left", externalFile:"shape-definitions.svg", scaleFactor:0.04}   , 
    downArrow: {externalShape:true, symbolId:"icon-arrow-thick-down", externalFile:"shape-definitions.svg", scaleFactor:0.04}    ,
    upArrow: {externalShape:true, symbolId:"icon-arrow-thick-up", externalFile:"shape-definitions.svg", scaleFactor:0.04}    ,
    rightArrow: {externalShape:true, symbolId:"icon-arrow-thick-right", externalFile:"shape-definitions.svg", scaleFactor:0.04}, 
    rightCheveron: {externalShape:true, symbolId:"icon-cheveron-right", externalFile:"shape-definitions.svg", scaleFactor:0.04}, 
    leftCheveron: {externalShape:true, symbolId:"icon-cheveron-left", externalFile:"shape-definitions.svg", scaleFactor:0.04}, 
    upCheveron: {externalShape:true, symbolId:"icon-cheveron-up", externalFile:"shape-definitions.svg", scaleFactor:0.04}, 
    downCheveron: {externalShape:true, symbolId:"icon-cheveron-down", externalFile:"shape-definitions.svg", scaleFactor:0.04}, 
    happySmiley: {externalShape:true, symbolId:"icon-mood-happy-outline", externalFile:"shape-definitions.svg", scaleFactor:0.04}, 
    neutralSmiley: {externalShape:true, symbolId:"icon-mood-neutral-outline", externalFile:"shape-definitions.svg", scaleFactor:0.04}, 
    sadSmiley: {externalShape:true, symbolId:"icon-mood-sad-outline", externalFile:"shape-definitions.svg", scaleFactor:0.04}, 
